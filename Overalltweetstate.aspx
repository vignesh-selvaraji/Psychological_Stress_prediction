<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Overalltweetstate.aspx.cs" Inherits="Overalltweetstate" Title="Untitled Page" %>

<%@ Register assembly="ZedGraph.Web" namespace="ZedGraph.Web" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel5" runat="server" Height="655px">
    <table class="style5">
        <tr>
        ...
        <tr>
            ...
            <td style="width: 515px; height: 293px">
                <asp:Panel ID="Panel2" runat="server" BackColor="White" BorderStyle="Solid" 
                        BorderWidth="1px" Height="617px" Width="717px">
                    <table class="style5">
                        <tr>
                            <td style="width: 215px">
                                    &nbsp;</td>
                            <td class="style6" style="width: 343px">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="style6" style="width: 343px">
                                ...
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Medium" 
                                        ForeColor="Black" Text="Overall Stress Level Of All Users"></asp:Label>
                            </td>
                            <td>
                                    &nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="style6" style="width: 343px">
                                <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="#000066" 
                                    Text="Overall Tweet State of All Users  :"></asp:Label>
                                &nbsp;
                    ...
                    <table class="style5">
                        <tr>
                            ...
                            <td style="width: 418px">
                                <cc1:ZedGraphWeb ID="ZedGraphWeb2" runat="server" Height="350" Width="500">
