                        ...
                        <table class="style5">
                            ...
                            <tr>
                                ...
                                <td class="style6">
                                    ...
                                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Medium" 
                                        ForeColor="Black" Text="Log in to your account."></asp:Label>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="style6">
                                    <asp:TextBox ID="TextBox1" runat="server" CssClass="textbox" Font-Bold="True" 
                                                    Font-Size="Large" Placeholder="Phone or Email" required Font-Names="Calibri"></asp:TextBox>
                                </td>
                                <td>
                                                &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="style6">
                                                ...
                                                <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="Aharoni" 
                                                    PostBackUrl="~/Sign up.aspx">Sign up &gt;&gt;</asp:LinkButton>
                                </td>
                                <td>
                                                &nbsp;</td>
                            </tr>
